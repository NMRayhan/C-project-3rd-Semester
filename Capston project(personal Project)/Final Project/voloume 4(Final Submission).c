...
void add_product()
{
    ...
    system("cls");
    printf("\n\n\n");
    printf("\t\t\tAdd more press 1 otherwise any Number Enter___");
    scanf("%d",&c);
    if(c==1)
    {
        system("cls");
...
void option(int number)
{
        ...
        else
        {
            printf("\a");
            char pMessage[256];
            sprintf(pMessage , "Please Choice Correct Number\n");
            MessageBox(NULL , pMessage , "Warning!!" , MB_OK);
            menu();
        }
    }
...
///user name and password is "rayhan"
void login()
{
    system("color 0A");
