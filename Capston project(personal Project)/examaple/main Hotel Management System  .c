...
{
    int h_customer;
    int restaurant_help,i;
    printf("Enter How Many Customer\n");
    scanf("%d",&h_customer);
    for(i=0; i<h_customer; i++)
    {
        printf("Enter customer name..\n");
        gets(visitor1[i].name);
        printf("Enter customer Gender..\n");
        gets(visitor1[i].gender);
        printf("Enter customer Nationality..\n");
        gets(visitor1[i].nationality);
        printf("Enter room Category..\n");
        gets(visitor1[i].r_category);
        printf("Enter Customer Phone Number..\n");
        scanf("%d",&visitor1[i].p_number);
        printf("Enter Customer Room Number..\n");
        scanf("%d",&visitor[i].r_number);
    }
