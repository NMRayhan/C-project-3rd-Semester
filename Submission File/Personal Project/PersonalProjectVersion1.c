#include<stdio.h>
#include<string.h>
char customer_name[20],deleted_customer_name[20],search_customer_name[20];
...
void Sweet()
{
    printf("*****************______our room service are______*****************\n");
    printf("\n");
    printf("\t\t1.Suite Room Will Generally few Bed for in Different Room in Float\n");
...
void booking()
{
    ...
    printf("\n\n\t\t if You want to continue again Press 1____");
    scanf("%d",&again);
    switch(again)
    {
    case 1:
